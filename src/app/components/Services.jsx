...
const services = [
  {
    ...
    desc: "Most brands look the part. Few feel it. We build identities that go beyond visuals, into the voice, the story, and the reason people keep coming back.",
  ...
  },
  {
    ...
    desc: "A beautiful interface that confuses people is just expensive decoration. We design experiences that think ahead of the user, intuitive, clean, and built to convert.",
  ...
  },
  {
    ...
    desc: "Ranking on Google isn't a hack. It's a habit. We build the kind of SEO foundation that compounds over time, visibility that grows without you having to chase it.",
  ...
  },
  {
    ...
    desc: "Posting isn't a strategy. We build one, content that fits your brand, speaks to your audience, and gives people a reason to follow, engage, and trust.",
  ...
  },
  {
    ...
    desc: "A slow, broken website loses customers before they've read a word. We build sites that are fast, clean, and engineered to perform on every device, every time.",
  ...
  },
  {
    ...
    desc: "Most digital problems aren't design problems or budget problems. They're direction problems. We fix that first, before anything else gets built.",
