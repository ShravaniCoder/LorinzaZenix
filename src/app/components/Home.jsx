...
>
  ...
  >
      ...
      {/* ══════════════════════════════════════════
          SECTION 3.5 — EXPANDABLE "HOW WE WORK" PROCESS
          Slides down / collapses up beneath the section above.
      ══════════════════════════════════════════ */}
      <AnimatePresence initial={false}>
        {processOpen && (
          <motion.section
            ...
            style={{
              ...
              position: "relative",
              background:
                "linear-gradient(180deg, #0A1422 0%, #0D1B2A 45%, #0B1726 100%)",
          ...
          >
            ...
            >
              ...
              <h2 style={{
                ...
                A Process Built For Results<AccentDot />
              </h2>
              <p style={{
              ...
              <div
                ...
                style={{ gap: "clamp(16px, 2vw, 24px)", textAlign: "left" }}
              >
                {[
                  {
                    n: "01", title: "Brief",
                    body: "We start by listening. Understanding your business, your goals, and what success actually looks like for you — before a single thing gets designed or written.",
                  },
                  {
                    n: "02", title: "Strategy",
                    body: "Every decision needs a reason behind it. We map out the direction — positioning, channels, messaging — so execution has a clear foundation to build on.",
                  },
                  {
                    n: "03", title: "Design & Build",
                    body: "This is where thinking becomes visible. Branding, UI/UX, development, content — crafted with precision and built to perform in the real world.",
                  },
                  {
                    n: "04", title: "Deliver & Grow",
                    body: "We don't hand off and disappear. We launch, track, refine, and stay invested in the outcome — because delivery is the beginning, not the end.",
                  },
                ].map((step) => (
                  <div
                    key={step.n}
                    style={{
                      ...
                      background:
                        "linear-gradient(150deg, rgba(27,38,59,0.55) 0%, rgba(13,27,42,0.30) 100%)",
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 24px 50px -18px rgba(0,0,0,0.6), 0 0 24px rgba(212,175,55,0.12)";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <span style={{
                      ...
                      color: "rgba(212,175,55,0.07)", pointerEvents: "none",
                      userSelect: "none",
                    }}>
                      {step.n}
                    </span>
                    ...
                    <p style={{
                      ...sora, color: "#D4AF37", fontSize: 11, fontWeight: 700,
                      letterSpacing: "0.18em", textTransform: "uppercase",
                    ...
                    <span style={{
                      ...
                      backgroundColor: "rgba(212,175,55,0.55)", marginBottom: 18,
                    }} />
                    <h3 style={{
                ...
                <div style={{ marginTop: 26 }}>
                  <button
                    ...
                    style={{
                      ...
                      textDecorationColor: "rgba(119,141,169,0.5)",
                      transition: "color 0.3s ease, text-decoration-color 0.3s ease",
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.color = "#D4AF37";
                      e.currentTarget.style.textDecorationColor = "rgba(212,175,55,0.7)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.color = C.support;
                      e.currentTarget.style.textDecorationColor = "rgba(119,141,169,0.5)";
                    }}
                  >
                    Hide it
                  </button>
