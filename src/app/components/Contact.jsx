    ...
    <div style={{ backgroundColor: C.dark }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ color: C.support, fontSize: 17, lineHeight: 1.8, maxWidth: 540, margin: "0 auto" }}>
      ...
      {/* ── INLINE QUICK FORM ── (WokWok-style dark section with inline form) */}
      <section style={{ backgroundColor: C.dark, padding: "96px 32px", textAlign: "center", borderTop: `1px solid rgba(65,90,119,0.15)` }}>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2" style={{ gap: 80, alignItems: "start" }}>
            ...
            <div>
              ...
              <p style={{ color: "rgba(13, 27, 42, 0.7)", fontSize: 14.5, lineHeight: 1.85, marginBottom: 44, textAlign: "center" }}>
                Whether you're ready to start a project, want a free consultation, or just have a question — we're here and happy to help.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 460, margin: "0 auto" }}>
                {[
              ...
              <div style={{
                ...
                border: "1px solid rgba(13, 27, 42, 0.12)",
                borderRadius: 0, padding: "24px 28px", marginTop: 44,
